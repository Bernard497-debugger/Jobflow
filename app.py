...
def search():
    ...
    if not jobs:
        content = '<div style="background:rgba(30,41,59,0.6);backdrop-filter:blur(10px);border:1px solid rgba(148,163,184,0.1);border-radius:15px;padding:40px;text-align:center;"><h3 style="color:#0ea5e9;margin-bottom:15px;font-size:20px;">No Jobs Found</h3><p style="color:#cbd5e1;margin-bottom:20px;">Try searching with different keywords or location.</p><p style="color:#cbd5e1;font-size:13px;margin-bottom:20px;">Tips:<br>- Use common job titles (e.g., "Software Developer", "Project Manager")<br>- Try different locations<br>- Be specific with your search</p><a href="/dashboard" style="display:inline-block;padding:12px 24px;background:linear-gradient(135deg, #0ea5e9 0%, #06b6d4 100%);color:white;border-radius:8px;text-decoration:none;font-weight:600;font-size:13px;text-transform:uppercase;">← Back to Dashboard</a></div>'
    else:
        content = ""
        for job in jobs:
